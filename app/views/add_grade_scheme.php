...
<div class="content-container dashboard">
    <div class="dashboard-container">
        <div class="content-panel">
            <h3 class="dashboard-section-title">Add Grade Schemes</h3>

            <form id="create-grade-scheme-form">
                <span class="input input--hoshi" style="width:45%">
                    <input value="" class="input__field input__field--hoshi" type="text" id="gs_description"  name="gs_description">
                ...
                <span class="input input--hoshi" style="width:45%">
                    <input value="" class="input__field input__field--hoshi" type="text" id="pass_threshold"  name="pass_threshold">
                ...
                <br>
                <input type="submit" class="outlined-button" value="Create" />
