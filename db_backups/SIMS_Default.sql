...
CREATE TABLE `grade_scheme_item_id` (
	...
	`grade_scheme_name` TEXT NOT NULL,
	`grade_scheme_id` int(10) NOT NULL,
...
ALTER TABLE `school_levels` ADD CONSTRAINT `school_levels_fk1` FOREIGN KEY (`grade_scheme_id`) REFERENCES `grade_scheme`(`grade_scheme_id`);
